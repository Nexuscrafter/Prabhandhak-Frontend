    ...
    <section className="py-24 bg-gray-900">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {[
            { img: "/assets/images/Innovative.jpg", title: "Innovative Strategy", text: "We craft bespoke digital strategies that resonate with your brand identity and target audience." },
            { img: "/assets/images/DataDriven.jpg", title: "Data Driven Insights", text: "Our strategies are backed by rigorous data analysis to ensure optimal engagement and ROI." },
            { img: "/assets/images/GlobalNetwork.jpg", title: "Global Network", text: "Leverage our vast network of influencers to expand your brand's reach globally." }
          ].map((feature, index) => (
            <motion.div
              key={index}
